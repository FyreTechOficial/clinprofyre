      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <a
            ...
            className="group flex items-center gap-4 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5"
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">suporte@fyreoficial.com</p>
            </div>
            <ExternalLink className="h-4 w-4 text-gray-300 ml-auto group-hover:text-brand-500 transition-colors" />
          </a>
          <a
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">(41) 99724-6413</p>
            </div>
            <ExternalLink className="h-4 w-4 text-gray-300 ml-auto group-hover:text-emerald-500 transition-colors" />
          </a>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {videoTutorials.map((video, i) => (
            <div
              key={i}
              className="group cursor-pointer rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5"
            >
