...
function GlobalSpotlight({
  ...
  useEffect(() => {
    ...
    spotlight.style.cssText = `position:fixed;width:1px;height:1px;pointer-events:none;z-index:-1;opacity:0;`;
...
// BentoCard — individual card with glow
...
// BentoGrid — wrapper with spotlight
